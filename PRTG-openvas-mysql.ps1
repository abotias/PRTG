...
$MySQLAdminUserName = 'mysqluser'
$passfile= "C:\Program Files (x86)\PRTG Network Monitor\Custom Sensors\EXEXML\credentials.txt"
...
$Query = "select * from tablawithcontains where ip='$device'"
